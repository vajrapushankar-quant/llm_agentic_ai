...
export default function AboutInstructorCard({
  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg px-6 md:px-8 lg:px-10 py-8 md:py-10">
      ...
      {projects && projects.length > 0 && (
        <ul className="space-y-2 mb-6 text-base md:text-lg text-gray-700">
